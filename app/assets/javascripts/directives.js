...
//=====================GRAD CARD DIRECTIVE=====================
      ...
      .directive('gradCardDirective', ['$location', '$rootScope', function($location, $rootScope) {
...
//=====================EMPL CARD DIRECTIVE=====================
      ...
      .directive('emplCardDirective', ['$location', '$rootScope', function($location, $rootScope) {
...
//=====================JOB CARD DIRECTIVE=====================
      ...
      .directive('jobCardDirective', ['$location', '$rootScope', function($location, $rootScope) {
...
//=====================SEARCH DIRECTIVE=====================
    ...
    .directive('searchDirective',['$location', '$rootScope', function($location, $rootScope) {
      return {
        restrict: 'E',
        scope: {
          data: '='
